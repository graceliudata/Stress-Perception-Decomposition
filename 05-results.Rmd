...
ggplot(subj1, aes(x = stressed, y = vid, fill = severity)) + 
  ...
  scale_fill_manual(values=c("cadetblue3", "khaki", "mediumorchid2", "snow4","springgreen4", "saddlebrown"))+ theme(axis.text.y = element_text(size=5))+ theme(legend.position="bottom")
