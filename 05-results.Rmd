...
obj <- read.csv("objective codes.csv")
...
v_content %>% arrange(desc(severity)) %>%
  ...
  scale_color_manual(values = c("#F9A1B9","#6BAEFE")) + labs(title = "Grouped by Sex")+ theme(legend.position="bottom")+ theme(axis.text.x = element_text(size=5))
